...
import theprime.device.BuildInfo
import theprime.device.BuildType
import theprime.extensions.landscapeSharedPreferencesName
import theprime.extensions.portraitSharedPreferencesName
import theprime.html.ListPageReader
import theprime.html.bookmark.BookmarkPageReader
import theprime.html.homepage.HomePageReader
import theprime.js.InvertPage
import theprime.js.TextReflow
import theprime.js.ThemeColor
...
import theprime.html.incognito.IncognitoPageReader
...
class AppModule {
    ...
    fun providesSuggestionsHttpClient(application: Application): Single<OkHttpClient> = Single.fromCallable {
        ...
        return@fromCallable OkHttpClient.Builder()
            .cache(Cache(suggestionsCache, theprime.utils.FileUtils.megabytesToBytes(1)))
