package theprime.database.adblock

import theprime.adblock.UnifiedFilterResponse
import theprime.database.adblock.UserRulesRepository.Companion.RESPONSE_BLOCK
import theprime.database.adblock.UserRulesRepository.Companion.RESPONSE_EXCLUSION
import theprime.database.adblock.UserRulesRepository.Companion.RESPONSE_NOOP
import theprime.database.databaseDelegate
...
class UserRulesDatabase @Inject constructor(
    ...
    private fun UnifiedFilterResponse.toContentValues() = ContentValues(10).apply {
        put(theprime.database.adblock.UserRulesDatabase.KEY_RESPONSE, response.toInt())
        put(theprime.database.adblock.UserRulesDatabase.KEY_PATTERN, filter.pattern)
        put(theprime.database.adblock.UserRulesDatabase.KEY_FILTER_TYPE, filter.filterType)
        put(theprime.database.adblock.UserRulesDatabase.KEY_CONTENT_TYPE, filter.contentType)
        put(theprime.database.adblock.UserRulesDatabase.KEY_THIRD_PARTY, filter.thirdParty)
        put(theprime.database.adblock.UserRulesDatabase.KEY_DOMAIN_MAP, filter.domains?.toDBString() ?: "")
    }
