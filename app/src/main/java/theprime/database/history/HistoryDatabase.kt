 ...
 */
package theprime.database.history

import theprime.database.HistoryEntry
import theprime.database.databaseDelegate
import theprime.extensions.firstOrNullMap
import theprime.extensions.useMap
...
class HistoryDatabase @Inject constructor(
    ...
    private fun HistoryEntry.toContentValues() = ContentValues().apply {
        put(theprime.database.history.HistoryDatabase.KEY_URL, url)
        put(theprime.database.history.HistoryDatabase.KEY_TITLE, title)
        put(theprime.database.history.HistoryDatabase.KEY_TIME_VISITED, lastTimeVisited)
    }
