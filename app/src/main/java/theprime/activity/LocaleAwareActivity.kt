...
abstract class LocaleAwareActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mLastLocale = theprime.locale.LocaleUtils.requestedLocale(userPreferences.locale)
        theprime.locale.LocaleUtils.updateLocale(this, mLastLocale)
    ...
    override fun onConfigurationChanged(newConfig: Configuration) {
        val requestedLocale = theprime.locale.LocaleUtils.requestedLocale(userPreferences.locale)
