...
import theprime.browser.sessions.SessionsPopupWindow
import theprime.browser.tabs.TabsDesktopView
import theprime.browser.tabs.TabsDrawerView
import theprime.database.Bookmark
import theprime.database.HistoryEntry
import theprime.database.SearchSuggestion
import theprime.database.WebPage
import theprime.database.bookmark.BookmarkRepository
import theprime.database.history.HistoryRepository
import theprime.databinding.ActivityMainBinding
import theprime.databinding.ToolbarContentBinding
import theprime.di.*
import theprime.dialog.BrowserDialog
import theprime.dialog.DialogItem
import theprime.dialog.LightningDialogBuilder
import theprime.enums.HeaderInfo
import theprime.extensions.*
import theprime.extensions.resizeAndShow
import theprime.extensions.snackbar
import theprime.html.bookmark.BookmarkPageFactory
import theprime.html.history.HistoryPageFactory
import theprime.html.homepage.HomePageFactory
import theprime.html.incognito.IncognitoPageFactory
import theprime.notifications.IncognitoNotification
import theprime.search.SearchEngineProvider
import theprime.search.SuggestionsAdapter
    ...
    override fun executeAction(@IdRes id: Int): Boolean {
        ...
        when (id) {
            ...
            R.id.action_translate -> {
                // Get our local
                val locale = theprime.locale.LocaleUtils.requestedLocale(userPreferences.locale)
...
//                }
    ...
    lateinit var iShortcuts: theprime.keyboard.Shortcuts
    ...
    private fun createKeyboardShortcuts() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            iShortcuts = theprime.keyboard.Shortcuts(this)
        }
    }
