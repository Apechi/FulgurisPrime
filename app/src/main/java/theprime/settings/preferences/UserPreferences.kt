package theprime.settings.preferences

import theprime.AccentTheme
import theprime.AppTheme
import theprime.BuildConfig
import theprime.R
import theprime.adblock.AbpUpdateMode
import theprime.browser.*
import theprime.constant.DEFAULT_ENCODING
import theprime.constant.Uris
import theprime.device.ScreenSize
import theprime.di.UserPrefs
import theprime.settings.preferences.delegates.*
...
import theprime.utils.FileUtils
import theprime.view.RenderingMode
import android.content.SharedPreferences
import theprime.browser.ProxyChoice
import theprime.browser.SuggestionNumChoice
import theprime.enums.LogLevel
import theprime.enums.HeaderInfo
import theprime.enums.LayerType
import theprime.settings.preferences.delegates.booleanPreference
import theprime.settings.preferences.delegates.enumPreference
import theprime.settings.preferences.delegates.floatResPreference
import theprime.settings.preferences.delegates.intPreference
import theprime.settings.preferences.delegates.stringPreference
