...
import theprime.extensions.reverseDomainName
            ...
            list?.forEach {
                view.postDelayed({
                    ...
                    faviconModel.faviconForUrl("http://$domain","",(activity as? ThemedActivity)?.isDarkTheme() == true)
                        ...
                        .subscribeBy(
                            onSuccess = { bitmap ->
                                pref.icon = bitmap.scale(theprime.utils.Utils.dpToPx(24f), theprime.utils.Utils.dpToPx(24f)).toDrawable(resources)
                            }
                        )
