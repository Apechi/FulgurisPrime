...
import theprime.R
import theprime.bookmark.LegacyBookmarkImporter
import theprime.bookmark.NetscapeBookmarkFormatImporter
import theprime.browser.TabsManager
import acr.browser.lightning.browser.sessions.Session
import theprime.database.bookmark.BookmarkExporter
...
import theprime.activity.SettingsActivity
...
import theprime.di.AdBlockPrefs
import theprime.di.DatabaseScheduler
import theprime.di.DevPrefs
import theprime.di.MainScheduler
import theprime.di.PrefsLandscape
import theprime.di.PrefsPortrait
import theprime.di.UserPrefs
import theprime.extensions.drawable
import theprime.extensions.fileName
import theprime.extensions.resizeAndShow
import theprime.extensions.snackbar
import theprime.extensions.toast
                                ...
                                .subscribeBy(
                                    ...
                                    onError = { throwable ->
                                        ...
                                        if (activity != null && !activity.isFinishing && isAdded) {
                                            theprime.utils.Utils.createInformativeDialog(activity, R.string.title_error, R.string.bookmark_export_failure)
                                        } else {
                ...
                context?.contentResolver?.openInputStream(uri).let { inputStream ->
                    ...
                    GlobalScope.launch(Dispatchers.Main) {
                        try {
                            ...
                            theprime.utils.Utils.createInformativeDialog(requireActivity(), R.string.title_error, R.string.import_bookmark_error)
                        }
                    }
                }
            }
