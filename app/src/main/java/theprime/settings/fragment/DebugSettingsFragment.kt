...
import theprime.R
import theprime.extensions.findViewByType
import theprime.extensions.onceOnLayoutChange
...
import theprime.utils.Utils.startActivityForFolder
...
class DebugSettingsFragment : AbstractSettingsFragment() {
    ...
    private fun openCrashLogsFolder() {
        startActivityForFolder(context, theprime.utils.FileUtils.getFolderCrashLogs().absolutePath)
    }
