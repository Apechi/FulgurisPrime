package theprime.favicon

import theprime.R
import theprime.extensions.invert
import theprime.extensions.pad
import theprime.extensions.safeUse
import theprime.utils.getFilteredColor
...
class FaviconModel @Inject constructor(
    ...
    private val faviconCache = object : LruCache<String, Bitmap>(theprime.utils.FileUtils.megabytesToBytes(1).toInt()) {
    ...
    fun createDefaultBitmapForTitle(title: String?): Bitmap {
        ...
        @ColorInt val defaultFaviconColor = theprime.utils.DrawableUtils.characterToColorHash(firstTitleCharacter, application)

        return theprime.utils.DrawableUtils.createRoundedLetterImage(
            firstTitleCharacter,
            bookmarkIconSize,
            bookmarkIconSize,
            defaultFaviconColor
