...
package theprime.view

import theprime.Capabilities
import theprime.R
import theprime.activity.ThemedActivity
import theprime.browser.TabModel
import theprime.activity.WebBrowserActivity
import theprime.constant.*
import theprime.browser.WebBrowser
import theprime.di.*
import theprime.dialog.LightningDialogBuilder
import theprime.download.LightningDownloadListener
import theprime.extensions.*
import theprime.isSupported
...
import theprime.settings.preferences.userAgent
import theprime.settings.preferences.webViewEngineVersionDesktop
...
import theprime.constant.Hosts
import theprime.constant.Schemes
import theprime.constant.Uris
import theprime.constant.WINDOWS_DESKTOP_USER_AGENT_PREFIX
import theprime.di.HiltEntryPoint
import theprime.di.configPrefs
import theprime.enums.LayerType
import theprime.extensions.canScrollVertically
import theprime.extensions.dp
import theprime.extensions.isDarkTheme
import theprime.extensions.makeSnackbar
import theprime.extensions.px
import theprime.extensions.removeFromParent
import theprime.extensions.setIcon
...
//        webView?.pauseTimers()
    ...
    companion object {
        ...
        private val SCROLL_UP_THRESHOLD = theprime.utils.Utils.dpToPx(10f)
        private val SCROLL_DOWN_THRESHOLD = theprime.utils.Utils.dpToPx(30f)
