...
import theprime.dialog.BrowserDialog.setDialogSize
import theprime.extensions.KDuration
...
import theprime.utils.guessFileName
...
class LightningDownloadListener     //Injector.getInjector(context).inject(this);
    ...
    val downloadHandler: theprime.download.DownloadHandler = hiltEntryPoint.downloadHandler
        ...
        if (intent.action == DownloadManager.ACTION_DOWNLOAD_COMPLETE) {
            ...
            if (downloadHandler.iDownloadId == id) {
                ...
                if (!success) {
                    ...
                    downloadsIntent =
                        theprime.utils.Utils.getIntentForDownloads(mActivity, userPreferences.downloadDirectory)
